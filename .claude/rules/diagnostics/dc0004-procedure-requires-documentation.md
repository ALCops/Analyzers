...
| Public control add-in procedures raise DC0004; control add-in events raise DC0009 | Both declarations form the AL contract a `usercontrol` consumer sees, even though the implementation is JavaScript. The event diagnostic uses event-specific terminology and remediation. |
