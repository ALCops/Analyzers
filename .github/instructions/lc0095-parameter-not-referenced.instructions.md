...
**HasFix (4 cases):** RemoveSingleParameter, RemoveMiddleParameter, RemoveMiddleParameterMultiline, RemoveSingleParameterWithPragma.
**NoFix (1 case):** ConditionalParameter.
**HasFixAll (5 cases):** RemoveTwoParametersSingleMethod, RemoveUnusedFromMultipleMethods, RemoveParametersWithComments, RemoveParametersWithPragmas, RemoveMixedProcedureKinds.
