...
namespace ALCops.ApplicationCop {
    ...
    internal class ApplicationCopAnalyzers {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Integration event &apos;{0}&apos; is declared in a codeunit with Access = Internal`, making it inaccessible to extensions. Remove the Access property or declare the event as an InternalEvent..
        /// </summary>
